...
const xlSeries = [
  {
    ...
    highlights: ['Powerful 26m air throw for faster cooling', '3-side high efficiency honeycomb cooling', 'Robust weather resistant body long life'],
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      'Auto Vertical Swing',
      'Fully Closable Horizontal Louvers',
      'Low Power Consumption – 215W x 2 Only',
      'Powerful 3 Speed Fan',
      'Easily Removable & Cleanable Cooling Pads',
      '3-Side Dust Filters for Pure Healthy Air',
      'Float Valve for Auto Water Filling',
  ...
  },
  {
    ...
    highlights: ['Powerful 25m air throw for faster coolingg', '3-side high efficiency honeycomb cooling', 'Robust weather resistant body long life'],
    features: [
...
const heavySeries = [
  {
    ...
    description:
      'Symphony Large Space Venti-Cooling includes a television commercial, aims to reach out to large industrial and commercial spaces. They include factories, warehouses, showrooms, educational institutions, hospitals, restaurants etc and educate them of the importance of a healthy and comfortable working environment for its workers or employees.',
...
const jumboSeries = [
  ...
  },
  {
    ...
    description:
      'Symphony movi-cooler has Large 100 L tank capacity, High efficiency honeycomb pad, Powerful 26 m air throw for faster air cooling, Robust weather resistant body for long life',
    // highlights: ['Powerful 25m air throw for faster cooling', '3-side high efficiency honeycomb cooling', 'Robust weather resistant body long life'],
    // features: [
    //   '8500 m³/hr Air Delivery',
    //   'Cool Flow Dispenser for Enhanced Cooling',
      ...
      <div className={`p-8 flex flex-col justify-between ${isEven ? '' : 'md:order-1'}`}>
        <div>
          ...
          {product.features?.length > 0 && (
            <h4 className="text-sm font-semibold text-primary-800 mb-2">Other Features:</h4>
          )}
          {/* Full feature list */}
          {product.features?.length > 0 && (
