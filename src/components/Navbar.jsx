    ...
    <>
      ...
      <div className="hidden lg:block bg-primary-900 text-white text-sm">
        <div className="container-custom flex justify-between items-center py-2">
          <span className="text-slate-300">India's Affordable Appliance Service — At Your Door Step</span>
          <div className="flex items-center gap-4">
            <a href="tel:+919840750471" className="flex items-center gap-1.5 hover:text-accent-400 transition-colors">
          ...
          {mobileOpen && (
            ...
            >
              <div className="container-custom py-4 flex flex-col gap-1">
                ...
                <a href="tel:+919840750471" className="flex items-center gap-2 text-sm text-primary-700 font-medium py-2 border-b border-slate-100 mb-2">
                  <HiPhone className="w-4 h-4" /> +919840750471
                </a>
                {navLinks.map((link) => (
                  <div key={link.href}>
                    {link.children ? (
